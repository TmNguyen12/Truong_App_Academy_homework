...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dispatch) {
    ...
    }); //giphy is the response that is returned from the API call 
  };
};
...
}; // gives every componnent access to the store 
...
var giphysSearch = function (_React$Component) {
  ...
  function giphysSearch() {
    ...
    _this.state = { searchTerm: '' }; // this doesn't have to be spelled out here, line 15 would've created it. 
...
}; // creating an object of props for that specific slice of state
